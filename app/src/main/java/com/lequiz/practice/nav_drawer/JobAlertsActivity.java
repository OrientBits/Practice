...
public class JobAlertsActivity extends AppCompatActivity implements ObservableScrollViewCallbacks{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title_text.setText(getResources().getText(R.string.job_alerts));
        ...
        shimmerFrameLayout = findViewById(R.id.shimmer_layout_container_job_alert);
