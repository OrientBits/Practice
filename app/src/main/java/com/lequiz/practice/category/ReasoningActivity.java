...
public class ReasoningActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_reasoning);
        ...
        title_text.setText(getResources().getText(R.string.reasoning));
        title_text.setTextColor(getResources().getColor(R.color.black));
        title_text.setAlpha(0);

        shimmerFrameLayout = findViewById(R.id.shimmer_layout_container_reasoning);
