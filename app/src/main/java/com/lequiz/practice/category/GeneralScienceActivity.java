...
public class GeneralScienceActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_general_science);
        ...
        title_text.setText(getResources().getText(R.string.general_science));
        title_text.setTextColor(getResources().getColor(R.color.black));
        title_text.setAlpha(0);

        shimmerFrameLayout = findViewById(R.id.shimmer_layout_container_general_science);
