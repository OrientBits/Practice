...
public class MathematicsActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_mathematics);
        ...
        title_text.setText(getResources().getText(R.string.mathematics));
        title_text.setTextColor(getResources().getColor(R.color.black));
        title_text.setAlpha(0);

        shimmerFrameLayout = findViewById(R.id.shimmer_layout_container_mathematics);
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back_arrow_mathematics);
