...
public class EnglishActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_english);
        ...
        title_text.setText(getResources().getText(R.string.english));
        title_text.setTextColor(getResources().getColor(R.color.black));
        title_text.setAlpha(0);

        shimmerFrameLayout = findViewById(R.id.shimmer_layout_container_english);
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_back_arrow_english);
