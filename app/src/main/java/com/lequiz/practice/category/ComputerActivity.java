...
public class ComputerActivity extends AppCompatActivity implements ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_computer);
        ...
        shimmerFrameLayout = findViewById(R.id.shimmer_layout_container_computer);
