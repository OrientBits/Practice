...
public class EntertainmentActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<News>> , ObservableScrollViewCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_entertainment);
        ...
        title_text.setText(getResources().getText(R.string.entertainment));
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.back_arrow_sport);
